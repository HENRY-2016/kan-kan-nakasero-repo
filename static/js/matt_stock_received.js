...
// var matt_sr_url = "http://127.0.0.1:5000/";
var matt_sr_url = "http://172.105.158.108:5000/";
...
function hide_sadolin_veiw_matt_divs ()
{
    
    document.getElementById("matt-root-div").style.display="none";
    document.getElementById("matt-view-all-div").style.display="none";
    document.getElementById("matt-search-by-size-div").style.display="none";
    document.getElementById("matt-search-by-date-div").style.display="none";
    document.getElementById("matt-from-to-div").style.display="none";
    document.getElementById("matt-search-by-last-week-div").style.display="none";
    document.getElementById("matt-search-by-this-month-div").style.display="none";
    document.getElementById("matt-search-by-last-month-div").style.display="none";
...
function show_budget_gloss_root_div ()
    {
        ...
        document.getElementById("matt-root-div").style.display="block";
    }
function close_stock_root_div ()
    { document.getElementById("matt-root-div").style.display="none";}


function show_matt_view_all_div ()
{
    document.getElementById("matt-search-by-size-div").style.display="none";
    document.getElementById("matt-search-by-date-div").style.display="none";
    document.getElementById("matt-from-to-div").style.display="none";
    ...
    document.getElementById("matt-search-by-this-month-div").style.display="none";
    document.getElementById("matt-search-by-last-month-div").style.display="none";
    document.getElementById("matt-view-all-div").style.display="block";

}
function close_matt_view_all_div ()
    {document.getElementById("matt-view-all-div").style.display="none";}


function show_matt_search_by_size_div ()
{
    document.getElementById("matt-search-by-date-div").style.display="none";
    document.getElementById("matt-from-to-div").style.display="none";
    document.getElementById("matt-view-all-div").style.display="none";
    ...
    document.getElementById("matt-search-by-this-month-div").style.display="none";
    document.getElementById("matt-search-by-last-month-div").style.display="none";
    document.getElementById("matt-search-by-size-div").style.display="block";
}
function close_matt_search_by_size_div ()
    {document.getElementById("matt-search-by-size-div").style.display="none";}

function show_matt_search_by_date_div ()
{
    document.getElementById("matt-from-to-div").style.display="none";
    document.getElementById("matt-view-all-div").style.display="none";
    document.getElementById("matt-search-by-size-div").style.display="none";
    ...
    document.getElementById("matt-search-by-this-month-div").style.display="none";
    document.getElementById("matt-search-by-last-month-div").style.display="none";
    document.getElementById("matt-search-by-date-div").style.display="block";
}
function close_matt_search_by_date_div ()
    {document.getElementById("matt-search-by-date-div").style.display="none";}

function show_matt_from_to_div ()
{
    document.getElementById("matt-view-all-div").style.display="none";
    document.getElementById("matt-search-by-size-div").style.display="none";
    document.getElementById("matt-search-by-date-div").style.display="none";
    ...
    document.getElementById("matt-search-by-this-month-div").style.display="none";
    document.getElementById("matt-search-by-last-month-div").style.display="none";
    document.getElementById("matt-from-to-div").style.display="block";
}
function close_matt_from_to_div ()
    {document.getElementById("matt-from-to-div").style.display="none";}



function show_matt_search_by_last_week_div ()
{
    document.getElementById("matt-view-all-div").style.display="none";
    document.getElementById("matt-search-by-size-div").style.display="none";
    document.getElementById("matt-search-by-date-div").style.display="none";
    ...
    document.getElementById("matt-search-by-this-month-div").style.display="none";
    document.getElementById("matt-search-by-last-month-div").style.display="none";
    document.getElementById("matt-search-by-last-week-div").style.display="block";
}
function close_matt_search_by_last_week_div ()
    {document.getElementById("matt-search-by-last-week-div").style.display="none";}


function show_matt_search_by_this_month_div ()
{
document.getElementById("matt-view-all-div").style.display="none";
    document.getElementById("matt-search-by-size-div").style.display="none";
    document.getElementById("matt-search-by-date-div").style.display="none";
    ...
    document.getElementById("matt-search-by-last-week-div").style.display="none";
    document.getElementById("matt-search-by-last-month-div").style.display="none"; 
    document.getElementById("matt-search-by-this-month-div").style.display="block";
}
function close_matt_search_by_this_month_div ()
    {document.getElementById("matt-search-by-this-month-div").style.display="none";}

function show_matt_search_by_last_month_div ()
{
    document.getElementById("matt-view-all-div").style.display="none";
    document.getElementById("matt-search-by-size-div").style.display="none";
    document.getElementById("matt-search-by-date-div").style.display="none";
    ...
    document.getElementById("matt-search-by-last-week-div").style.display="none";
    document.getElementById("matt-search-by-this-month-div").style.display="none";
    document.getElementById("matt-search-by-last-month-div").style.display="block";
}
function close_matt_search_by_last_month_div ()
    {document.getElementById("matt-search-by-last-month-div").style.display="none";}
...
function stock_view_all ()
    {
        ...
        req.open('post', matt_sr_url+'matt_stock_view_all',true)
        req.onload = function ()
            {
...
function stock_view_by_name ()
{
    ...
    let req = new XMLHttpRequest();
    req.open('post', matt_sr_url+'matt_stock_view_by_name',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_view_by_size ()
{
    document.getElementById("received-stock-loader-size").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', matt_sr_url+'matt_stock_view_by_size',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_view_by_date_today ()
{
    document.getElementById("received-stock-loader-date-today").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', matt_sr_url+'matt_stock_view_by_date_today',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_view_by_date_date ()
{
    document.getElementById("received-stock-loader-date-date").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', matt_sr_url+'matt_stock_view_by_date_date',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_from_to_all ()
{
    document.getElementById("received-stock-loader-from-to-all").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', matt_sr_url+'matt_from_to_all',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_last_week_all ()
{
    document.getElementById("received-stock-loader-last-week-all").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', matt_sr_url+'matt_last_week_all_data',true)
    req.onload = function ()
        {
            document.getElementById("received-stock-loader-last-week-all").style.display="none";
            let results = JSON.parse(this.responseText);
...
function stock_this_month_all ()
{
    document.getElementById("received-stock-loader-this-month-all").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', matt_sr_url+'matt_this_month_all_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
...
function stock_last_month_all ()
{
    document.getElementById("received-stock-loader-last-month-all").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', matt_sr_url+'matt_last_month_all_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
{
    document.getElementById("show-all-tbody").innerHTML = localStorage.getItem("matt_all");
    document.getElementById("stock-view-by-size-tbody").innerHTML = localStorage.getItem("matt_by_size");
    document.getElementById("stock-view-by-date-today-tbody").innerHTML = localStorage.getItem("matt_date_today");
    document.getElementById("date-date-tbody").innerHTML = localStorage.getItem("matt_date_date");
    document.getElementById("from-to-all-tbody").innerHTML = localStorage.getItem("matt_from_to")
    document.getElementById("last-week-all-tbody").innerHTML = localStorage.getItem("matt_last_week_all");
    document.getElementById("this-month-all-tbody").innerHTML = localStorage.getItem("matt_dis_mth_all");
    document.getElementById("last-month-all-tbody").innerHTML = localStorage.getItem("matt_lst_mth_all");
}
