...
function stock_flow_all ()
    {
        ...
        req.open('post', url+'matt_stock_flow_view_all',true)
        req.onload = function ()
            {
...
function stock_flow_size ()
{
    document.getElementById("stock-flow-loader-size").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'matt_stock_flow_view_by_size',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_date_today ()
{
     document.getElementById("stock-flow-loader-date-today").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'matt_stock_flow_view_by_date_today',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_date_date ()
{
    document.getElementById("stock-flow-loader-date-date").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'matt_stock_flow_view_by_date_date',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_from_to_all ()
{
     document.getElementById("stock-flow-loader-from-to-all").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'matt_stock_flow_from_to_all',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_last_week_all()
{
    document.getElementById("stock-flow-loader-last-week-all").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'matt_stock_flow_last_week_all_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_this_month_all ()
{
    document.getElementById("stock-flow-loader-this-month-all").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'matt_stock_flow_this_month_all_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_last_month_all ()
{
    document.getElementById("stock-flow-loader-last-month-all").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'matt_stock_flow_last_month_all_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_status_all ()
{
    document.getElementById("stock-status-loader-all").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'matt_stock_status_all_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
...
function save_stock_status_all ()
{
    ...
    localStorage.setItem("matt_stock_status_all", data);
}
...
{
    document.getElementById("stock-flow-all-tbody").innerHTML = localStorage.getItem("matt_stock_flow_all");
    document.getElementById("stock-flow-view-by-size-tbody").innerHTML = localStorage.getItem("matt_stock_flow_by_size");
    document.getElementById("stock-flow-view-by-date-today-tbody").innerHTML = localStorage.getItem("matt_stock_flow_date_today");
    document.getElementById("stock-flow-date-date-tbody").innerHTML = localStorage.getItem("matt_stock_flow_date_date");
    document.getElementById("stock-flow-from-to-all-tbody").innerHTML = localStorage.getItem("matt_stock_flow_from_to")
    document.getElementById("stock-flow-last-week-all-tbody").innerHTML = localStorage.getItem("matt_stock_flow_last_week_all");
    document.getElementById("stock-flow-this-month-all-tbody").innerHTML = localStorage.getItem("matt_stock_flow_dis_mth_all");
    document.getElementById("stock-flow-last-month-all-tbody").innerHTML = localStorage.getItem("matt_stock_flow_lst_mth_all");

    // STOCK STATUS
    document.getElementById("stock-status-all-tbody").innerHTML = localStorage.getItem("matt_stock_status_all");
}
