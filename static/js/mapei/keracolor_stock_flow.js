...
function hide_stock_flow_divs ()
{
    ...
    document.getElementById("status-search-by-name-div").style.display = "none";
...
function close_stock_flow_by_date_div (){document.getElementById("stock-flow-by-date-div").style.display="none";}
...
function close_stock_flow_from_to_div (){document.getElementById("stock-flow-from-to-div").style.display="none";}
...
function close_stock_flow_last_week_div (){document.getElementById("stock-flow-last-week-div").style.display="none";}
...
function close_stock_flow_this_month_div (){document.getElementById("stock-flow-this-month-div").style.display="none";}
...
function close_stock_flow_last_moth_div (){document.getElementById("stock-flow-last-month-div").style.display="none";}
...
// stock status
// =============
function show_stock_status_view_all_div (){document.getElementById("stock-status-view-all-div").style.display="block";}
function close_stock_status_view_all_div (){document.getElementById("stock-status-view-all-div").style.display="none";}

function show_stock_status_by_name_div (){document.getElementById("status-search-by-name-div").style.display="block";}
function close_stock_status_by_name_div (){document.getElementById("status-search-by-name-div").style.display="none";}
...
function show_stock_status_by_name_div ()
{
    document.getElementById("status-search-by-name-div").style.display="block";
    document.getElementById("stock-status-view-all-div").style.display="none";
}function close_stock_status_by_name_div (){document.getElementById("status-search-by-name-div").style.display="none";}
...
// grand childrens
function stock_flow_date_today_grand_child_div (){document.getElementById("stock-flow-date-today-grand-child-div").style.display="block";}
...
function stock_flow_date_date_grand_child_div (){document.getElementById("stock-flow-date-date-grand-child-div").style.display="block";}
...
function stock_flow_from_to_all_grand_child_div (){document.getElementById("stock-flow-from-to-all-grand-child-div").style.display="block";}
function close_stock_flow_from_to_all_grand_child_div (){document.getElementById("stock-flow-from-to-all-grand-child-div").style.display="none";}
function stock_flow_last_week_all_child_div (){document.getElementById("stock-flow-last-week-all-child-div").style.display="block";}
...
function stock_flow_this_month_all_grand_child_div (){document.getElementById("stock-flow-this-month-all-grand-child-div").style.display="block";}
...
function stock_flow_last_month_all_grand_child_div (){document.getElementById("stock-flow-last-month-all-grand-child-div").style.display="block";}
...
function stock_flow_all ()
    {
        ...
        req.open('post', keracolor_url+'keracolor_stock_flow_view_all',true)
        req.onload = function ()
            {
...
// ============================= view by name
function fetch_stock_flow_by_name_data ()
{
    document.getElementById("stock-flow-loader-name").style.display="block";
    setTimeout(stock_flow_by_name,loader_seconds)
}
function stock_flow_by_name ()
{
    document.getElementById("stock-flow-loader-name").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', keracolor_url+'keracolor_stock_flow_by_name',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
                ...
                {
                    let tbody = document.getElementById('stock-flow-by-name-tbody');
                    tbody.innerHTML = ' ';
        ...
        let stock_flow_by_name = new FormData(document.getElementById('stock-flow-by-name-form'));
        req.send(stock_flow_by_name);   
        setTimeout(save_stock_flow_by_name_data,seconds);     
}
...
function stock_flow_date_today ()
{
    document.getElementById("stock-flow-loader-date-today").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', keracolor_url+'keracolor_stock_flow_view_by_date_today',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length){alert("No results found")}
...
function stock_flow_date_date ()
{
    document.getElementById("stock-flow-loader-date-date").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', keracolor_url+'keracolor_stock_flow_view_by_date_date',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_from_to_all ()
{
     document.getElementById("stock-flow-loader-from-to-all").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', keracolor_url+'keracolor_stock_flow_from_to_all',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_last_week_all()
{
    document.getElementById("stock-flow-loader-last-week-all").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', keracolor_url+'keracolor_stock_flow_last_week_all_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_this_month_all ()
{
    document.getElementById("stock-flow-loader-this-month-all").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', keracolor_url+'keracolor_stock_flow_this_month_all_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_flow_last_month_all ()
{
    document.getElementById("stock-flow-loader-last-month-all").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', keracolor_url+'keracolor_stock_flow_last_month_all_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_status_all ()
{
    document.getElementById("stock-status-loader-all").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', keracolor_url+'keracolor_stock_status_all_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
...
// ============================= view by name
function fetch_stock_status_by_name_data ()
{
    document.getElementById("stock-status-loader-name").style.display="block";
    setTimeout(stock_status_by_name,loader_seconds)
}
function stock_status_by_name ()
{
    document.getElementById("stock-status-loader-name").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', keracolor_url+'keracolor_stock_status_by_name',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
                ...
                {
                    let tbody = document.getElementById('stock-status-by-name-tbody');
                    tbody.innerHTML = ' ';

                    let td,tr;
                    let th_names = new Array ();
                    th_names.push(["Name", "Quatity"]);
                    let columns_to_count = th_names[0].length;
                    row = tbody.insertRow(-1); 
                    for (let looper =0; looper<columns_to_count; ++looper)
                        {
        ...
        let stock_status_by_name = new FormData(document.getElementById('stock-status-by-name-form'));
        req.send(stock_status_by_name);   
        setTimeout(save_stock_status_by_name_data,seconds);     
}
/*
    @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    @
...
function save_stock_flow_all_data ()
{
    ...
    localStorage.setItem("keracolor_stock_flow_all", data);
}

function save_stock_flow_by_name_data ()
{
    let data = document.getElementById ("stock-flow-by-name-tbody").innerHTML;
...
function save_stock_status_all ()
{
    ...
    localStorage.setItem("keracolor_stock_status_all", data);
}

function save_stock_status_by_name_data ()
{
    let data = document.getElementById ("stock-status-by-name-tbody").innerHTML;
    localStorage.setItem("stock_status_name", data);
}
...
{
    document.getElementById("stock-flow-all-tbody").innerHTML = localStorage.getItem("keracolor_stock_flow_all");
    document.getElementById("stock-flow-by-name-tbody").innerHTML = localStorage.getItem("keracolor_by_name");
    document.getElementById("stock-flow-view-by-date-today-tbody").innerHTML = localStorage.getItem("keracolor_stock_flow_date_today");
    document.getElementById("stock-flow-date-date-tbody").innerHTML = localStorage.getItem("keracolor_stock_flow_date_date");
    document.getElementById("stock-flow-from-to-all-tbody").innerHTML = localStorage.getItem("keracolor_stock_flow_from_to")
    document.getElementById("stock-flow-last-week-all-tbody").innerHTML = localStorage.getItem("keracolor_stock_flow_last_week_all");
    document.getElementById("stock-flow-this-month-all-tbody").innerHTML = localStorage.getItem("keracolor_stock_flow_dis_mth_all");
    document.getElementById("stock-flow-last-month-all-tbody").innerHTML = localStorage.getItem("keracolor_stock_flow_lst_mth_all");

    // STOCK STATUS
    document.getElementById("stock-status-all-tbody").innerHTML = localStorage.getItem("keracolor_stock_status_all");
    document.getElementById("stock-status-by-name-tbody").innerHTML = localStorage.getItem("stock_status_name");
}
