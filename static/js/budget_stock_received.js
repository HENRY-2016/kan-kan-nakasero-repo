...
function hide_sadolin_veiw_bg_divs ()
{
    
    document.getElementById("budget-gloss-root-div").style.display="none";
    document.getElementById("bg_view_all_div").style.display="none";
    document.getElementById("bg_search_by_name_div").style.display="none";
    document.getElementById("bg_search_by_size_div").style.display="none";
    document.getElementById("bg_search_by_date_div").style.display="none";
    document.getElementById("bg_from_to_div").style.display="none";
    document.getElementById("bg_search_by_last_week_div").style.display="none";
    document.getElementById("bg_search_by_this_month_div").style.display="none";
    document.getElementById("bg_search_by_last_month_div").style.display="none";
...
function show_budget_gloss_root_div ()
    {
        ...
        document.getElementById("budget-gloss-root-div").style.display="block";
    }
function close_stock_root_div ()
    { document.getElementById("budget-gloss-root-div").style.display="none";}


function show_bg_view_all_div ()
{
    document.getElementById("bg_search_by_name_div").style.display="none";
    document.getElementById("bg_search_by_size_div").style.display="none";
    document.getElementById("bg_search_by_date_div").style.display="none";
    ...
    document.getElementById("bg_search_by_this_month_div").style.display="none";
    document.getElementById("bg_search_by_last_month_div").style.display="none";
    document.getElementById("bg_view_all_div").style.display="block";

}
function close_bg_view_all_div ()
    {document.getElementById("bg_view_all_div").style.display="none";}

function show_bg_search_by_name_div ()
{
    document.getElementById("bg_search_by_size_div").style.display="none";
    document.getElementById("bg_search_by_date_div").style.display="none";
    document.getElementById("bg_from_to_div").style.display="none";
    ...
    document.getElementById("bg_search_by_this_month_div").style.display="none";
    document.getElementById("bg_search_by_last_month_div").style.display="none";
    document.getElementById("bg_search_by_name_div").style.display="block";
}
function close_bg_search_by_name_div ()
    {document.getElementById("bg_search_by_name_div").style.display="none";}

function show_bg_search_by_size_div ()
{
    document.getElementById("bg_search_by_date_div").style.display="none";
    document.getElementById("bg_from_to_div").style.display="none";
    document.getElementById("bg_view_all_div").style.display="none";
    ...
    document.getElementById("bg_search_by_this_month_div").style.display="none";
    document.getElementById("bg_search_by_last_month_div").style.display="none";
    document.getElementById("bg_search_by_size_div").style.display="block";
}
function close_bg_search_by_size_div ()
    {document.getElementById("bg_search_by_size_div").style.display="none";}

function show_bg_search_by_date_div ()
{
    document.getElementById("bg_from_to_div").style.display="none";
    document.getElementById("bg_view_all_div").style.display="none";
    document.getElementById("bg_search_by_name_div").style.display="none";
    ...
    document.getElementById("bg_search_by_this_month_div").style.display="none";
    document.getElementById("bg_search_by_last_month_div").style.display="none";
    document.getElementById("bg_search_by_date_div").style.display="block";
}
function close_bg_search_by_date_div ()
    {document.getElementById("bg_search_by_date_div").style.display="none";}

function show_bg_from_to_div ()
{
    document.getElementById("bg_view_all_div").style.display="none";
    document.getElementById("bg_search_by_name_div").style.display="none";
    document.getElementById("bg_search_by_size_div").style.display="none";
    ...
    document.getElementById("bg_search_by_this_month_div").style.display="none";
    document.getElementById("bg_search_by_last_month_div").style.display="none";
    document.getElementById("bg_from_to_div").style.display="block";
}
function close_bg_from_to_div ()
    {document.getElementById("bg_from_to_div").style.display="none";}



function show_bg_search_by_last_week_div ()
{
    document.getElementById("bg_view_all_div").style.display="none";
    document.getElementById("bg_search_by_name_div").style.display="none";
    document.getElementById("bg_search_by_size_div").style.display="none";
    ...
    document.getElementById("bg_search_by_this_month_div").style.display="none";
    document.getElementById("bg_search_by_last_month_div").style.display="none";
    document.getElementById("bg_search_by_last_week_div").style.display="block";
}
function close_bg_search_by_last_week_div ()
    {document.getElementById("bg_search_by_last_week_div").style.display="none";}


function show_bg_search_by_this_month_div ()
{
document.getElementById("bg_view_all_div").style.display="none";
    document.getElementById("bg_search_by_name_div").style.display="none";
    document.getElementById("bg_search_by_size_div").style.display="none";
    ...
    document.getElementById("bg_search_by_last_week_div").style.display="none";
    document.getElementById("bg_search_by_last_month_div").style.display="none"; 
    document.getElementById("bg_search_by_this_month_div").style.display="block";
}
function close_bg_search_by_this_month_div ()
    {document.getElementById("bg_search_by_this_month_div").style.display="none";}

function show_bg_search_by_last_month_div ()
{
    document.getElementById("bg_view_all_div").style.display="none";
    document.getElementById("bg_search_by_name_div").style.display="none";
    document.getElementById("bg_search_by_size_div").style.display="none";
    ...
    document.getElementById("bg_search_by_last_week_div").style.display="none";
    document.getElementById("bg_search_by_this_month_div").style.display="none";
    document.getElementById("bg_search_by_last_month_div").style.display="block";
}
function close_bg_search_by_last_month_div ()
    {document.getElementById("bg_search_by_last_month_div").style.display="none";}
...
function stock_view_all ()
    {
        ...
        req.open('post', url+'bg_stock_view_all',true)
        req.onload = function ()
            {
...
function stock_view_by_name ()
{
    document.getElementById("received-stock-loader-name").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'bg_stock_view_by_name',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_view_by_size ()
{
    document.getElementById("received-stock-loader-size").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'bg_stock_view_by_size',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_view_by_date_today ()
{
    document.getElementById("received-stock-loader-date-today").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'bg_stock_view_by_date_today',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_view_by_date_date ()
{
    document.getElementById("received-stock-loader-date-date").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'bg_stock_view_by_date_date',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_view_by_date_name_date ()
{
    document.getElementById("received-stock-loader-date-name-date").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'bg_stock_view_by_date_date_name',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_from_to_all ()
{
    document.getElementById("received-stock-loader-from-to-all").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'bg_from_to_all',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_from_to_name ()
{
    document.getElementById("received-stock-loader-from-to-name").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'bg_from_to_name',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            if (! results || !results.length)
...
function stock_last_week_all ()
{
    document.getElementById("received-stock-loader-last-week-all").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'bg_last_week_all_data',true)
    req.onload = function ()
        {
            document.getElementById("received-stock-loader-last-week-all").style.display="none";
            let results = JSON.parse(this.responseText);
...
function stock_last_week_name ()
{
    document.getElementById("received-stock-loader-last-week-name").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'bg_last_week_name_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            console.log(results);
...
function stock_this_month_all ()
{
    document.getElementById("received-stock-loader-this-month-all").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'bg_this_month_all_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            console.log(results);
...
function stock_this_month_name ()
{
    document.getElementById("received-stock-loader-this-month-name").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'bg_this_month_by_name_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            console.log(results);
...
function stock_last_month_all ()
{
    document.getElementById("received-stock-loader-last-month-all").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'bg_last_month_all_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            console.log(results);
...
function stock_last_month_name ()
{
    document.getElementById("received-stock-loader-last-month-name").style.display="none";
    let req = new XMLHttpRequest();
    req.open('post', url+'bg_last_month_name_data',true)
    req.onload = function ()
        {
            let results = JSON.parse(this.responseText);
            console.log(results);
...
function save_stock_view_by_name_data ()
{
    ...
    localStorage.setItem("by_name", data);
}
function save_stock_view_by_size_data ()
{
    let data = document.getElementById ("stock-view-by-size-tbody").innerHTML;
    localStorage.setItem("by_size", data);
}
function save_by_date_today_data ()
{
    let data = document.getElementById ("stock-view-by-date-today-tbody").innerHTML;
    localStorage.setItem("date_today", data);
}
function save_date_date_data ()
{
    let data = document.getElementById ("date-date-tbody").innerHTML;
    localStorage.setItem("date_date", data);
}
function save_date_date_name ()
{
    let data = document.getElementById ("date-date-name-tbody").innerHTML;
    localStorage.setItem("date_date_name", data);
}

function save_from_to ()
{
    let data = document.getElementById("from-to-all-tbody").innerHTML;
    localStorage.setItem("from_to",data);
}
function save_from_to_name ()
{
    let data = document.getElementById("from-to-name-tbody").innerHTML;
    localStorage.setItem("from_to_name",data);
}
function save_show_last_week_all ()
{
    let data = document.getElementById ("last-week-all-tbody").innerHTML;
    localStorage.setItem("last_week_all", data);
}
function save_show_last_week_name ()
{
    let data = document.getElementById ("last-week-name-tbody").innerHTML;
    localStorage.setItem("last_week_name", data);
}
function save_show_this_month_all ()
{
    let data = document.getElementById ("show-all-tbody").innerHTML;
    localStorage.setItem("dis_mth_all", data);
}
function save_show_this_month_by_name_data ()
{
    let data = document.getElementById ("this-month-by-name-tbody").innerHTML;
    localStorage.setItem("dis_mth_name", data);
}
function save_show_last_month_all ()
{
    let data = document.getElementById ("last-month-all-tbody").innerHTML;
    localStorage.setItem("lst_mth_all", data);
}
function save_show_last_month_by_name_data ()
{
    let data = document.getElementById ("last-month-by-name-tbody").innerHTML;
    localStorage.setItem("lst_mth_name", data);
}

// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
function Load_offline_data () 
{
    document.getElementById("show-all-tbody").innerHTML = localStorage.getItem("all");
    document.getElementById("stock-view-by-name-tbody").innerHTML = localStorage.getItem("by_name");
    document.getElementById("stock-view-by-size-tbody").innerHTML = localStorage.getItem("by_size");
    document.getElementById("stock-view-by-date-today-tbody").innerHTML = localStorage.getItem("date_today");
    document.getElementById("date-date-tbody").innerHTML = localStorage.getItem("date_date");
    document.getElementById("date-date-name-tbody").innerHTML = localStorage.getItem("date_date_name");
    document.getElementById("from-to-all-tbody").innerHTML = localStorage.getItem("from_to")
    document.getElementById("from-to-name-tbody").innerHTML = localStorage.getItem("from_to_name")
    document.getElementById("last-week-all-tbody").innerHTML = localStorage.getItem("last_week_all");
    document.getElementById("last-week-name-tbody").innerHTML = localStorage.getItem("last_week_name");
    document.getElementById("this-month-all-tbody").innerHTML = localStorage.getItem("dis_mth_all");
    document.getElementById("this-month-by-name-tbody").innerHTML = localStorage.getItem("dis_mth_name");
    document.getElementById("last-month-all-tbody").innerHTML = localStorage.getItem("lst_mth_all");
    document.getElementById("last-month-by-name-tbody").innerHTML = localStorage.getItem("lst_mth_name");
}
