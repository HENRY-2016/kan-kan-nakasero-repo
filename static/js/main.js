...
function Hide_New_Orders_Div ()
{
    document.getElementById("new-orders-div").style.display="none";
}
function Show_New_Orders_Div ()
{
    document.getElementById("new-orders-div").style.display="block";
}
